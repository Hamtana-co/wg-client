  ...
  return (
    <main className="w-screen h-screen flex flex-col justify-center items-center">
      <div className="w-full flex justify-center items-center h-full">
        <div className="rounded-[35px] max-w-[420px] max-h-[620px] w-full h-full p-5 border-2 border-[#ffffff4a] flex flex-col justify-between items-center rtl bg-[#70737b1c] ">
          <div className="flex flex-col justify-center items-center gap-5">
            <h1 className="text-[#D1BBFF] text-3xl ">
              <Link href="#">We Gamers</Link>
            </h1>

            <h4 className="text-white text-2xl font-bold"> عضویت در سایت </h4>
          ...
          <form action="" className="flex flex-col gap-6 w-full">
            ...
            <div className="flex flex-col justify-between gap-3">
              ...
              <Link href="/login" className="bg-[#70737b47] border-b-4 border-[#10101147] w-full py-4 px-2 flex justify-center items-center rounded-2xl text-white gap-2">
